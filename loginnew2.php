    ...
    <div class="container" id="container">
        <div class="form-container sign-up">
            <form method="post" action="">
                ...
                <button type="submit" name="bt1"  style="background-color:#63F; color:#FFF;">Sign Up</button>
           </form>
        </div>
        <div class="form-container sign-in">
            <form action="loginnew3.php" method="post">
                ...
                <button type="submit" name="bt2"  style="background-color:#63F; color:#FFF;">Sign In</button>
            </form>
        </div>
...
$pwd=$_POST['t3'];
	...
	if($res)
	{
		...
		echo "<script>window.locatio.href = 'loginnew2.php'</script>";
        die();
	}
	else
	{
